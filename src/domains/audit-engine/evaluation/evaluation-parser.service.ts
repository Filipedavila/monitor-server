...
import { calculateConform, calculatePageSize, calculateTotalElements, createEvaluationData } from "./evaluation-metrics.domain";
 ...
 public parseIngestionMetrics(
    ...
    return Object.entries(metrics).map(([key, value]) => {
      ...
      return {
        ...
        this.logger.error(`Failed to parse metric for rule ${key}: ${error instanceof Error ? error.message : String(error)}`);
        return null;
      }
