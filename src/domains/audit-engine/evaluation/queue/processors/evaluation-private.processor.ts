...
*/
  ...
  onFailed(job: Job, error: Error) {
    ...
    this.evaluationStore.delete({ evaluationId: job.data.evaluationId, websiteId: job.data.websiteId, pageId: job.data.pageId, evaluationDate: new Date().toISOString() });
