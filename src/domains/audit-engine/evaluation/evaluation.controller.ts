...
export class EvaluationController {
  ...
  @Get("page/:pageId/evaluation/:evaluationId/nodes")
  @Roles(RoleSlug.ADMIN,RoleSlug.MONITOR)
  async getPageEvaluationDetails(
    ...
    const securityContext = { user: user };
    const fileStream = await this.evaluationService.getEvaluationResultJson(websiteId, pageId, evaluationId, securityContext);
    res.set({
  ...
  async getPageEvaluationHtml(
    ...
    const securityContext = { user: user };
    const fileStream = await this.evaluationService.getEvaluationHtml(websiteId, pageId, evaluationId, securityContext);
    res.set({
