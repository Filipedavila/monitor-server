...
export class UserService {
  ...
  findNumberOfStudyMonitor(): Promise<number> {
    return this.userRepository.count({ where: { role: { slug: "studies" } } });
  }

  findNumberOfMyMonitor(): Promise<number> {
    return this.userRepository.count({ where: { role: { slug: "monitor" } } });
  }
  ...
  findNumberOfAMS(): Promise<number> {
    return this.userRepository.count({ where: { role: { slug: "admin" } } });
  }
