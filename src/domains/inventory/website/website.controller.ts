...
export class WebsiteController {
  ...
  async updateWebsitePagesObservatory(
    ...
    return success(
      await this.websiteService.updatePagesObservatory(
        updateObservatoryPages,
        userId,
      ),
    );
  }
  ...
  @ApiOperation({
    summary: "Get count of pages for a specific website with search filter",
  })
  @ApiResponse({
    status: 200,
    description:
      "The number of pages in the website matching the search criteria",
    type: Number,
  })
  @UseGuards(AuthGuard("jwt-admin"))
  ...
  async getWebsitePagesCount(
    ...
    const websiteId =
      await this.websiteService.getFirstIdFromWebsiteFromFilterUserAndName(
        user,
        website,
      );
  ...
  @ApiOperation({
    summary: "Get paginated and sorted pages for a specific website",
  })
  @ApiResponse({
    status: 200,
    description:
      "The pages of the website with pagination, sorting and filtering",
    type: Array<Page>,
  })
  @UseGuards(AuthGuard("jwt-admin"))
