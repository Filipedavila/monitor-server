...
constructor(
  ...
  private async handleCrawl(websiteId: number) {
    console.log("Starting crawl for websiteId:", websiteId);
    const website = new CrawlWebsiteNew();
    website.CrawlWebsiteId = websiteId;
    await this.crawlWebsiteRepository.save(website);
